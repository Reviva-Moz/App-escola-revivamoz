...
import { 
    ...
    AIConfiguration, MessageTemplate, AttendanceRecord
} from '../types';
...
import {
    ...
    ATTENDANCE_DATA, RECENT_ACTIVITIES_DATA, MESSAGE_TEMPLATES_DATA
} from '../constants';
...
export const DataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const value: DataContextType = {
        ...
        tuition, attendance, activities, aiConfiguration, messageTemplates,
